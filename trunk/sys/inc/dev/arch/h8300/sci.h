...
#ifndef DEV_H8300_SCI_H
#define DEV_H8300_SCI_H
 ...
 */
extern void DEV_h8300_sci_open (int port,
 ...
 * @param port : 0 or 1
 */
extern void DEV_h8300_sci_close (int port);
 ...
 */
extern void DEV_h8300_sci_start (int port,
                                 DEV_serial_t * serial);
 ...
 */
extern void DEV_h8300_sci_txe (int port,
                               DEV_serial_t * serial);
 ...
 * @param serial : Serial device
 */
extern void DEV_h8300_sci_txi (int port,
                               DEV_serial_t * serial);
 ...
 * @param serial : Serial device
 */
extern void DEV_h8300_sci_rxi (int port,
                               DEV_serial_t * serial);
 ...
 * @param serial : Serial device
 */
extern void DEV_h8300_sci_eri (int port,
                               DEV_serial_t * serial);
