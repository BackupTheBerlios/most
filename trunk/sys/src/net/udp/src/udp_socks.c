...
udp_find_exact_sock (NET_netif_t * inp, struct NET_ip_hdr *iphdr, ACE_u16_t src, ACE_u16_t dest)
{
...
static NET_udp_socket_t *
udp_find_sock (struct NET_ip_hdr *iphdr, ACE_u16_t src, ACE_u16_t dest)
{
    NET_udp_socket_t *sock = NULL;
...
NET_udp_find_sock (NET_netif_t * inp, struct NET_ip_hdr *iphdr, ACE_u16_t src, ACE_u16_t dest)
{
    NET_udp_socket_t *sock = NULL;
