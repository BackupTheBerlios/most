...
static ACE_bool_t find_id(const long id_list[], long id)
{
...
static ACE_bool_t slot_put_event(USO_slot_t *slot, USO_node_t *event, ACE_bool_t block)
{
...
extern ACE_bool_t USO_slots_put_event(USO_list_t *slots, USO_slot_t *iterator, USO_node_t *event, ACE_bool_t block)
{
