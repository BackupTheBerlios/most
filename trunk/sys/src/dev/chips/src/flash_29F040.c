...
extern enum FLASH_29F040_err_code
FLASH_29F040_programm_s (volatile unsigned char *addr, unsigned char *data, unsigned long len)
{
    enum FLASH_29F040_err_code err;
    USO_cpu_status_t ps;
    ps = USO_disable ();
...
extern enum FLASH_29F040_err_code
FLASH_29F040_programm_ns (volatile unsigned char *addr, unsigned char *data, unsigned long len)
{
    enum FLASH_29F040_err_code err = FLASH_29F040_ok;
