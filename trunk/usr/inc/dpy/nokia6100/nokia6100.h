...
extern void DPY_nokia6100_set_rectangle (int x1, int y1, int x2, int y2, unsigned char fill, int color);
...
extern void DPY_nokia6100_write_bitmap (const unsigned char bmp[], int x1, int x2, int y1, int y2, int size);
