...
set_exec (char *arg)
{
    ...
    if (arg != NULL)
    {
        ...
        case 'e':
            ...
            break;
        case 'i':
            config_set_ip_addr (arg, &SAM_config.ip_addr);
            break;
        case 'n':
            config_set_ip_addr (arg, &SAM_config.netmask);
            break;
        case 'g':
            config_set_ip_addr (arg, &SAM_config.gateway);
            break;
        case 's':
            config_set_ip_addr (arg, &SAM_config.server);
            break;
        case 'f':
