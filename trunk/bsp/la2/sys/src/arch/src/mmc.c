...
#define LA2_GET_BUFS              1
#define LA2_MMC_BLOCK_SIZE        (DEV_MMC_BLOCK_SIZE)
#define LA2_PARTITION_1_BLOCKS    ((unsigned long)10)
#define LA2_PARTITION_2_BLOCKS    ((unsigned long)10)
#define LA2_PARTITION_3_BLOCKS    ((unsigned long)(512 * 8 + 2))

#define LA2_PARTITION_1_START     ((unsigned long)0)
#define LA2_PARTITION_1_END       (LA2_PARTITION_1_START + LA2_PARTITION_1_BLOCKS)
#define LA2_PARTITION_2_START     (LA2_PARTITION_1_END)
#define LA2_PARTITION_2_END       (LA2_PARTITION_2_START + LA2_PARTITION_2_BLOCKS)
#define LA2_PARTITION_3_START     (LA2_PARTITION_2_END)
#define LA2_PARTITION_3_END       (LA2_PARTITION_3_START + LA2_PARTITION_3_BLOCKS)
...
char get_bufs[LA2_GET_BUFS][DEV_MMC_BLOCK_SIZE];
...
LA2_mmc_install(void)
{
    ...
    DEV_mmc_install ();
    disc_install(dir = MFS_resolve("/bsp"));
    MFS_close_desc (dir);
    return ACE_OK;
}
