...
#define PWM_DELAY_SERVO        (PWM_PERIOD_SERVO - PWM_DUTY_SERVO)
#define PWM_PULSE_SERVO        (PWM_DUTY_SERVO)
...
LA2_pwm_init (void)
{
    ...
    CSP_PWM4CConfigureChannel(PWM0, PWM_CHANNEL_SERVO,  (PWM_PRESCALAR_SERVO | PL), PWM_DELAY_SERVO, PWM_PULSE_SERVO);
    ...
    DEV_pwm_init (&LA2_servo, &pwm4c, PWM_CHANNEL_SERVO);
    DEV_pwm_set_period (&LA2_servo, PWM_PERIOD_SERVO, PWM_DUTY_SERVO);
