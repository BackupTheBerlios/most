...
static void init_pic(void)
{
    ...
    USO_out_b(0x20, 0x11); // Initialisierungsbefehl fuer den PIC
    USO_out_b(0x21, 0x20); // Interruptnummer fuer IRQ 0
    USO_out_b(0x21, 0x04); // An IRQ 2 haengt der Slave
    USO_out_b(0x21, 0x01); // ICW 4

    // Slave-PIC initialisieren
    USO_out_b(0xa0, 0x11); // Initialisierungsbefehl fuer den PIC
    USO_out_b(0xa1, 0x28); // Interruptnummer fuer IRQ 8
    USO_out_b(0xa1, 0x02); // An IRQ 2 haengt der Slave
    USO_out_b(0xa1, 0x01); // ICW 4
